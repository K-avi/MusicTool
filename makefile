...
test: scalegen.o harmo.o parsing.o  user_info.o globals.o init.o chordgen.o rand.o misc.o chordprint.o parseloop.o writeenv.o syntaxcheck.o dodecseries.o genfuncs.o extchord.o main_test.o 
	$(CC) -o $@ $(CFLAGS) $^
